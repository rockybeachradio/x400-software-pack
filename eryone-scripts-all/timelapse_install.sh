...
################################################################################################
# File: timelapse_installer.sh
# Author: Eryone
# Date: 20250711
# purpose: Installation script for moonraker-timelapse
#
# Changes made by Eryone:
# --> Search for "(by eryone)" to find the postions in the document.
#   - function main()
#       continue_install  - commented out (by eryone)
#       stop_service  - commented out (by eryone)
#       start service  - commented out (by eryone)
#   - function check_ffmpeg()
#       sudo apt-get update  - commented out (by eryone)
#   - function initial_check()
#       echo makerbase | sudo -S  apt-get install --yes "${PKGLIST}"  - added "echo makerbase |" (by eryone)
#
# relink_conf.sh copies it to $HOME/moonraker-timelapse/install.sh
################################################################################################
...
#stop_services               # commented out (by eryone)
...
#start_services             # commented out (by eryone)
